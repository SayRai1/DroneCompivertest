...
% UniSannio image-processing / path-planning parameters required by the
% copied flightControlSystem (DISK_KERNEL, SQUARE_KERNEL, MIN_RADIUS_CROWN,
% MAX_RADIUS_CROWN, GAIN_TRACK, GAIN_LANDING, COG_X, COG_Y, FOV, Z_LOW,
% Z_HIGH, FLAG_WAIT_FOR_HOVERING, ...).  Without this the Image Processing
% and Path Planning blocks fail with "variable does not exist".
variables;
